...
// // --4 : Afficher uen boite de dialogue (2 façons)
...
// document.write("A la pause vous aurez des shokobons !");
...
// // --9 : Une variable ne peut pas commencer par un chiffre, ne doit contenir que des caractères alphanumériques, et ne peut pas être un mot reservé (var, for, ... des éléments natifs du langage JS)

//  https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Mots_r%C3%A9serv%C3%A9s

// // --10 : Une variable peut être déclaréee de façon explicite :
// var fruit;
// var fruit = "fraise";
// ou implicite:
// var fruit_2 = "coco"
...
// --1. Chaîne de caractères (STRING) toujours entre guillemets
var vacances = "2018";
...
// --5. Les Constantes
// La déclaration const permet de creér une constante accessible uniquement en lecture. Contrairement à une variable, sa valeur ne peut plus être modifiée par réaffectation plus bas dans le code. Une constante ne peut être déclarée à nouveau dans le même JavaScript
...
// En Js les variables sont auto-typées, on peut convertir une variable de type number en string et inversement avec les fonctions natives de JS
